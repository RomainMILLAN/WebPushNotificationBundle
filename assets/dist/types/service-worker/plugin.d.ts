...
export type ClickOutcome = 'already-there' | 'navigated' | 'new-window' | 'nudged' | 'focus-only' | 'rejected' | 'post-sent' | 'post-failed';
/**
...
export interface WebPushPlugin {
    ...
    onMessage?(message: {
        type: string;
        [key: string]: unknown;
    }, reply: Reply, context: PluginContext): void | Promise<void>;
