 ...
 */
export declare const SW_VERSION = "1";
...
export declare const DEFAULT_STATE_CACHE = "web-push-state";
/** `{ clickPath, at, marker }`, written by the worker before navigating, claimed by a page. */
export declare const INTENT_KEY = "/__web-push/navigation-intent";
/** `[{ at, outcome, verdict, clientCount, intent }]`, newest first, never any path. */
export declare const TRAIL_KEY = "/__web-push/click-trail";
/** `{ marker }`: the client state marker last announced by a page. */
export declare const MARKER_KEY = "/__web-push/client-state";
/**
 ...
 */
export declare const INTENT_MAX_AGE_MS = 300000;
/** How many clicks the diagnostic trail remembers. */
export declare const TRAIL_MAX_ENTRIES = 10;
/** Message types exchanged between the page and the worker. */
export declare const MessageType: {
    readonly workerPing: "worker-ping";
    readonly workerPong: "worker-pong";
    readonly clientState: "client-state";
    readonly forgetClientState: "forget-client-state";
    readonly readClickTrail: "read-click-trail";
    readonly clickTrail: "click-trail";
    readonly claimNavigationIntent: "claim-navigation-intent";
};
...
export type ClickVerdict = 'no-destination' | 'rejected-parse' | 'rejected-scheme' | 'rejected-cross-origin' | 'rejected-prefix' | 'accepted';
 ...
 */
export declare function parseMarker(raw: unknown): string | null;
